...
/// Search input + horizontally-scrollable filter controls (Sort / Genre / Year
/// / Min rating) shared by both search tabs. Owns its own [SearchFilters] state
/// and emits the latest value via [onChanged]; text changes are debounced.
...
class _SearchFilterBarState extends State<SearchFilterBar> {
  ...
  void _onQueryChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 450), () {
      _emit(_filters.copyWith(query: value));
    });
  }
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: widget.kind == MediaKind.movie
                  ? 'Search movies'
                  : 'Search TV series',
...
/// A [FilterChip] whose label reflects the current selection and which opens a
/// bottom-sheet picker. Selecting the active value again clears the filter.
